...
define('tpl!show/tpl/main_view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<table class="table table-striped"><thead><tr><th>Date</th>    <th>',new Date(dt),'</th></tr></thead><tbody><tr>        <td>Humidity</td>        <td>',humidity,'</td>        </tr><tr>        <td>Pressure</td>        <td>',pressure,'</td>        </tr><tr>        <td>Speed</td>        <td>',speed,'</td>        </tr><tr>            <td>Morning Temperature</td>        <td>',temp.morn,'</td>        </tr><tr>            <td>Day Temperature</td>        <td>',temp.day,'</td>        </tr><tr>        <td>Evening Temperature</td>        <td>',temp.eve,'</td>        </tr><tr>            <td>Night Temperature</td>        <td>',temp.night,'</td>    </tr></tbody></table>');}return __p.join('');}});

define('show/show_view',["app", "tpl!show/tpl/main_view.tpl"], function(WeatherApp, mainViewTemplate){
...
define('common/views',["app", "tpl!common/templates/loading.tpl", "spin.jquery"], function(WeatherApp, loadingTpl) {
	WeatherApp.module("Common.Views", function(Views, WeatherApp, Backbone, Marionette, $, _) {
	...
	return WeatherApp.Common.Views;
});

define('entity/entity',["app"], function(WeatherApp) {
...
define('show/show_controller',["app", "show/show_view", "common/views"], function(WeatherApp, ShowView, CommonViews) {
	WeatherApp.module("Show", function(Show, WeatherApp, Backbone, Marionette, $, _) {
		Show.Controller = {
			showView: function() {
